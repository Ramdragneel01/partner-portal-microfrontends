        ...
        MuiCssBaseline: {
            styleOverrides: {
                ':root': {
                    ...
                    '--pp-scrollbar-thumb-hover': 'rgba(238, 238, 238, 0.34)',
                    '--pp-scrollbar-thumb-active': 'rgba(238, 238, 238, 0.52)',
                },
                'html, body, #root': {
                    scrollbarWidth: 'thin',
                ...
                '*:hover, *:focus-within, *:active': {
                    scrollbarColor: 'var(--pp-scrollbar-thumb-hover) var(--pp-scrollbar-track)',
                },
                '*::-webkit-scrollbar': {
                    width: '0.72rem',
                    height: '0.72rem',
                ...
                '*::-webkit-scrollbar-track': {
                    backgroundColor: 'var(--pp-scrollbar-track)',
                },
                ...
                '*:hover::-webkit-scrollbar-thumb, *:focus-within::-webkit-scrollbar-thumb': {
                    backgroundColor: 'var(--pp-scrollbar-thumb-hover)',
                },
                '*:active::-webkit-scrollbar-thumb': {
                    backgroundColor: 'var(--pp-scrollbar-thumb-active)',
                },
